...
class ObapThemeManager {
    ...
    _createThemeItems() {
        ...
        root.style.setProperty('--obap-lighten-color', 'rgba(255, 255, 255, 0.10)');
        root.style.setProperty('--obap-darken-color', 'rgba(0, 0, 0, 0.05)');

        // Border Radius
        root.style.setProperty('--obap-border-radius-none', '0');
        root.style.setProperty('--obap-border-radius-normal', '3px');
        root.style.setProperty('--obap-border-radius-circle', '50%');
        root.style.setProperty('--obap-border-radius-pill', '9999px');
    }
...
const themeManager = new ObapThemeManager();
